...
export class SQLiteMailStorage {
  ...
  private seedDemoData(): void {
    ...
    const demoEmails: EmailMessage[] = [
      ...
      // Account 1 - Sent
      {
        ...
        subject: 'Chỉ đạo hoàn thiện hệ thống VuaMail chuẩn Fluent UI Outlook 365',
      ...
      msg_1: {
        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #242424;">
            <h2 style="color: #0078d4; margin-top: 0;">Chào mừng Sếp đến với VuaMail — VuaOffice Suite</h2>
            <p>Kính gửi Sếp Châu,</p>
            <p>Ứng dụng <strong>VuaMail</strong> đã được nâng cấp toàn diện với kiến trúc hiện đại:</p>
            <ul>
        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6;">
            ...
            <ul>
              ...
              <li><strong>Kế hoạch triển khai VuaMail</strong>: File PDF lộ trình phát triển v0.7.0.</li>
            </ul>
  ...
  addAccount(account: {
    ...
    this.data.emails.unshift({
      ...
      snippet: `Tài khoản mail ${account.email} đã được cấu hình thành công với giao thức ${account.provider.toUpperCase()} trên VuaMail...`,
    ...
    this.data.bodies[welcomeMsgId] = {
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6;">
          ...
          <p>Tài khoản email của bạn đã được kết nối thành công vào VuaMail trong hệ sinh thái VuaOffice Suite.</p>
          <ul>
