      ...
      <div className="brain-scroll-area">
        ...
        <div className="brain-header">
          <div className="brain-header-main">
            <h1 className="brain-title">Cài đặt & Tài khoản (Settings & Accounts)</h1>
            <div className="brain-subtitle">
              Quản lý tài khoản kết nối, xác thực an toàn OAuth / IMAP, chữ ký và cấu hình hệ thống VuaMail
            </div>
          </div>
                ...
                {addStep === 'choose_provider' && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
                      ...
                      >
                        <IconGlobe size={26} color="var(--vuamail-primary-blue, #0077cd)" />
