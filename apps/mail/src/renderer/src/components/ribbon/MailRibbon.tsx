  ...
  return (
    <div className="ribbon">
      ...
      <div className="ribbon-tabs">
        ...
        {/* Top-right AI Trigger & Active Account */}
        <div className="ribbon-tabs-right">
          ...
          {activeAccountEmail && (
            <div className="account-badge" title={`Tài khoản đang mở: ${activeAccountEmail}`}>
              <span className="status-dot" />
              <span className="account-email-text">{activeAccountEmail}</span>
            </div>
          )}
        </div>
      </div>
