  ...
  return (
    <div className="ribbon">
      ...
      <div className="ribbon-tabs">
        ...
        {/* Top-right AI Trigger & Active Account / Profile button */}
        <div className="ribbon-tabs-right">
          ...
          <button
            type="button"
            className={`account-badge-btn ${isProfileActive ? 'active' : ''}`}
            onClick={onOpenProfile}
            title="Cài đặt tài khoản & Cấu hình VuaMail"
          >
            <span className="account-avatar-circle">
              {(activeAccountEmail || 'Châu Lê').charAt(0).toUpperCase()}
            </span>
            <span className="status-dot" />
            <span className="account-email-text">{activeAccountEmail || 'Cài đặt & Tài khoản'}</span>
          </button>
        </div>
      </div>
            ...
            <div className="ribbon-group">
              <div className="ribbon-group-items">
                <button
                  ...
                  onClick={onToggleAi}
                  title="Mở bảng trợ lý AI Mail Copilot"
                >
                  <span className="rb-big-icon">
